...
const Sidebar: React.FC<SidebarProps> = ({ currentView, onViewChange, onLogout, userName, isOAuth, userRole = 'student', userPlan = 'free' }) => {
  ...
  const navGroups: NavGroup[] = [
    ...
    },
    {
      ...
      emoji: '🧠',
      items: [
        { id: 'prontuarioInteligente', label: 'Prontuário Inteligente', icon: 'M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z', badge: 'ia' },
        { id: 'verificadorInteracoes', label: 'Interações (OpenFDA)', icon: 'M13 10V3L4 14h7v7l9-11h-7z', badge: 'ia' },
        ...
        { id: 'triagemPreditiva', label: 'Triagem Preditiva', icon: 'M8 10h.01M12 10h.01M16 10h.01M9 16H5a2 2 0 01-2-2V6a2 2 0 012-2h14a2 2 0 012 2v8a2 2 0 01-2 2h-5l-5 5v-5z', badge: 'ia' },
      ]
    },
    {
      label: 'ViralGram',
